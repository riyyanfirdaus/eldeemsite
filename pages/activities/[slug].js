        ...
        <Layout pageTitle="Kegiatan">
            <div className="lg:min-h-screen sm:min-h-[30vh] mt-16">
                ...
                <div className="md:w-96 w-80 rounded-lg shadow-lg p-6 mx-auto transform -translate-y-16 bg-white px-6 py-10 relative">
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-accent rounded-t-lg w-36 h-10 flex"><span className="text-xl m-auto text-secondary font-bold">{dataActDetail.properties.Status.select.name}</span></div>
                </div>
