const Footer = () => {
    return (
        <>
         <footer className="footer p-10 bg-secondary">
         ...
         <footer className="footer footer-center px-10 py-4 bg-secondary text-primary">
